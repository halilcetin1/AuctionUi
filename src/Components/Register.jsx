    ...
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div >
                ...
                <div className="mt-6">
                    <label htmlFor="roles" className="block text-sm font-medium leading-5 text-gray-700">
                      Roles
                    </label>
                    <div className="mt-1 relative rounded-md shadow-sm">
                    <select name="" id="" 
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-1 rounded-md shadow-sm relative">
                        <input id="password" name="password" type={show ? "password":"text"} 
                            ...
                            {
                                show ? <FaEye className=" absolute  right-2 cursor-pointer top-2 text-2xl" onClick={()=>{setShow(!show)}}/> :<FaEyeSlash  className=" absolute  right-2 cursor-pointer top-2 text-2xl" onClick={()=>setShow(!show)}/>
                            }
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-1 rounded-md shadow-sm">
                        <input id="password_confirmation" name="password_confirmation" type="password" required
                            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" onChange={(e)=>setConfirmPassword(e.target.value)}/>
                    </div>
